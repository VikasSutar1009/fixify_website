...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className="fixed top-4 left-1/2 -translate-x-1/2 z-40 w-[80%] sm:w-[88%] max-w-[800px]">

  <div className="bg-white/90 backdrop-blur-md px-4 sm:px-6 py-2 rounded-full flex items-center justify-between shadow-md">
    ...
    <div className="flex items-center gap-3 sm:gap-4">
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="fixed top-20 left-1/2 -translate-x-1/2 w-[90%] max-w-[320px] bg-white rounded-2xl shadow-xl p-5 flex flex-col gap-5 text-center z-30">
